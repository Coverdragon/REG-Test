Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon Outline Early/b4da5febe45feb341b432d2259143be0"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.76 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.469 /*_MatcapScreen*/), matcap, matcapMask, (0.15 /*_MatcapEmissionStrength*/), (0.649 /*_MatcapLightMask*/), (1.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			#ifdef POI_AUDIOLINK
