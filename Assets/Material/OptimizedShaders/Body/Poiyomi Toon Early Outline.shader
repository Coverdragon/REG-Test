Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon Outline Early/d279dcd2f13172b4dbd254cafd672587"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.7254258,0.7254258,0.7254258,1);
				#ifdef POI_AUDIOLINK
			...
			{
				float3 x0, x1, x2;
				float3 conv = lerp(GreenWrapSH(wrap), GreenWrapSHOpt(wrap), (0.189 /*_LightingWrappedNormalization*/)); // Should try optimizing this...
			...
			void calculateShading(inout PoiLight poiLight, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam)
			{
				...
				if ((3.0 /*_LightingAdditiveType*/) == 1)
				{
					...
					#endif
					float2 ToonAddGradient = float2((0.0 /*_LightingAdditiveGradientStart*/), (0.921 /*_LightingAdditiveGradientEnd*/));
				...
				#endif
				float shadowStrength = (0.479 /*_ShadowStrength*/) * poiLight.shadowMask;
				#ifdef POI_PASS_OUTLINE
				shadowStrength = lerp(0, shadowStrength, (0.0 /*_OutlineShadowStrength*/));
				#endif
				#ifdef _LIGHTINGMODE_WRAPPED
				#define GREYSCALE_VECTOR float3(.33333, .33333, .33333)
				float3 directColor = _LightColor0.rgb * saturate(RTWrapFunc(poiLight.nDotL, (0.96 /*_LightingWrappedWrap*/), (0.189 /*_LightingWrappedNormalization*/)));
				float3 indirectColor = 0;
				#ifdef UNITY_PASS_FORWARDBASE
				indirectColor = ShadeSH9_wrapped(poiMesh.normals[(1.0 /*_LightingIndirectUsesNormals*/)], (0.96 /*_LightingWrappedWrap*/)) * poiLight.occlusion;
				#endif
				...
				poiLight.rampedLightMap = saturate((poiLight.lightMap - (1 - (1.0 /*_LightingGradientEnd*/))) / saturate((1 - (0.0 /*_LightingGradientStart*/)) - (1 - (1.0 /*_LightingGradientEnd*/)) + fwidth(poiLight.lightMap)));
				float3 mathRamp = lerp(float3(1, 1, 1), saturate(lerp((float4(0.03954624,0.03954624,0.03954624,1) * lerp(indirectColor, 1, (0.0 /*_LightingIgnoreAmbientColor*/))), float3(1, 1, 1), saturate(poiLight.rampedLightMap))), (0.479 /*_ShadowStrength*/));
				directColor *= saturate(poiLight.rampedLightMap + 1 - (0.479 /*_ShadowStrength*/)) * float4(1,1,1,1);
				...
				poiLight.finalLighting = finalWrap * saturate(mathRamp + 1 - (0.479 /*_ShadowStrength*/));
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.attenuationStrength = (0.25 /*_LightingCastedShadows*/);
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				matcapALD.matcapALEmissionAdd = float4(0,1,0,0);
				matcapALD.matcapALIntensityAddBand = (0.0 /*_Matcap0ALIntensityAddBand*/);
				matcapALD.matcapALIntensityAdd = float4(0,1,0,0);
				matcapALD.matcapALChronoPanType = (0.0 /*_Matcap0ALChronoPanType*/);
				matcapALD.matcapALChronoPanBand = (4.0 /*_Matcap0ALChronoPanBand*/);
				matcapALD.matcapALChronoPanSpeed = (33.07 /*_Matcap0ALChronoPanSpeed*/);
				float3 normal0 = lerp(poiMesh.normals[0], poiMesh.normals[1], (0.159 /*_MatcapNormal*/));
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (3.0 /*_MatcapUVMode*/), (0.0 /*_MatcapUVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_MatcapRotation*/), (0.42 /*_MatcapBorder*/), normal0, poiCam, poiLight, poiMesh, (0.159 /*_MatcapNormal*/), matcapALD);
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					float mipCount0 = 9;
					if (float4(0.015625,0.015625,64,64).z == 8192) mipCount0 = 13;
					if (float4(0.015625,0.015625,64,64).z == 4096) mipCount0 = 12;
					if (float4(0.015625,0.015625,64,64).z == 2048) mipCount0 = 11;
					if (float4(0.015625,0.015625,64,64).z == 1024) mipCount0 = 10;
					if (float4(0.015625,0.015625,64,64).z == 512) mipCount0 = 9;
					if (float4(0.015625,0.015625,64,64).z == 256) mipCount0 = 8;
					if (float4(0.015625,0.015625,64,64).z == 128) mipCount0 = 7;
					if (float4(0.015625,0.015625,64,64).z == 64) mipCount0 = 6;
					if (float4(0.015625,0.015625,64,64).z == 32) mipCount0 = 5;
				...
				#if defined(PROP_MATCAPMASK) || !defined(OPTIMIZER_ENABLED)
				matcapMask = POI2D_SAMPLER_PAN(_MatcapMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_MatcapMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(3.0 /*_MatcapMaskChannel*/)];
				#else
				matcapMask = 1;
				#endif
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.956 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.649 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				matcapALD.matcapALChronoPanBand = (4.0 /*_Matcap1ALChronoPanBand*/);
				matcapALD.matcapALChronoPanSpeed = (33.07 /*_Matcap1ALChronoPanSpeed*/);
				float3 normal1 = lerp(poiMesh.normals[0], poiMesh.normals[1], (0.159 /*_Matcap2Normal*/));
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (3.0 /*_Matcap2UVMode*/), (0.0 /*_Matcap2UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap2Rotation*/), (0.42 /*_Matcap2Border*/), normal1, poiCam, poiLight, poiMesh, (0.159 /*_Matcap2Normal*/), matcapALD);
				if ((0.0 /*_Matcap2SmoothnessEnabled*/))
				{
					float mipCount2 = 9;
					if (float4(0.015625,0.015625,64,64).z == 8192) mipCount2 = 13;
					if (float4(0.015625,0.015625,64,64).z == 4096) mipCount2 = 12;
					if (float4(0.015625,0.015625,64,64).z == 2048) mipCount2 = 11;
					if (float4(0.015625,0.015625,64,64).z == 1024) mipCount2 = 10;
					if (float4(0.015625,0.015625,64,64).z == 512) mipCount2 = 9;
					if (float4(0.015625,0.015625,64,64).z == 256) mipCount2 = 8;
					if (float4(0.015625,0.015625,64,64).z == 128) mipCount2 = 7;
					if (float4(0.015625,0.015625,64,64).z == 64) mipCount2 = 6;
					if (float4(0.015625,0.015625,64,64).z == 32) mipCount2 = 5;
				...
				{
					matcap2.rgb = hueShift(matcap2.rgb, (0.624 /*_Matcap2HueShift*/) + _Time.x * (0.0 /*_Matcap2HueShiftSpeed*/), (0.0 /*_Matcap2HueShiftColorSpace*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (1.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.25 /*_Matcap2EmissionStrength*/), (0.649 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			#ifdef POI_AUDIOLINK
			...
			{
				float volume = AudioLinkLerpMultiline(ALPASS_DFT + float2(poiMesh.uv[(0.0 /*_ALVolumeColorUV*/)][(1.0 /*_ALVolumeColorDirection*/)] * AUDIOLINK_ETOTALBINS, 0.0)).b;
				float3 lowColor = float4(1,1,1,1).rgb * poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_ALVolumeColorLowThemeIndex*/));
				float3 midColor = float4(0.3408722,1,0,1).rgb * poiThemeColor(poiMods, float4(0.3408722,1,0,1).rgb, (0.0 /*_ALVolumeColorMidThemeIndex*/));
				float3 highColor = float4(0,0.03063284,1,1).rgb * poiThemeColor(poiMods, float4(0,0.03063284,1,1).rgb, (0.0 /*_ALVolumeColorHighThemeIndex*/));
				float3 volumeColor = lerp(lowColor, midColor, saturate(volume * 2));
				volumeColor = lerp(volumeColor, highColor, saturate(volume * 2 - 1));
				float3 emissionColor = lerp(lowColor * (0.0 /*_ALLowEmission*/), midColor * (0.0 /*_ALMidEmission*/), saturate(volume * 2));
				...
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor, customBlend(poiFragData.baseColor, volumeColor, (9.0 /*_ALVolumeColorBlendType*/)), saturate((1.0 /*_ALVolumeColorBlendAlpha*/) * poiMods.audioLinkAvailable));
				#endif
			}
			#endif
			#endif
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.045 /*_GITDEMinLight*/), (0.285 /*_GITDEMaxLight*/), (1.0 /*_GITDEMinEmissionMultiplier*/), (0.18 /*_GITDEMaxEmissionMultiplier*/), (1.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/), poiLight);
				#if defined(PROP_EMISSIONMAP) || !defined(OPTIMIZER_ENABLED)
				if (!(0.0 /*_EmissionCenterOutEnabled*/))
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(0,0,0,0)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, _EmissionColor.rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (1.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, _EmissionColor.rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, _EmissionColor.rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				if ((0.0 /*_ScrollingEmission*/))
				{
					...
					{
						emissionStrength0 *= calculateScrollingEmission(float4(0,-10,0,0).xyz, (10.0 /*_EmissiveScroll_Velocity*/), (20.0 /*_EmissiveScroll_Interval*/), (1.0 /*_EmissiveScroll_Width*/), (0.0 /*_EmissionScrollingOffset*/), pos);
					}
				}
				...
				emissionColor0 = lerp(emissionColor0, dot(emissionColor0, float3(0.3, 0.59, 0.11)), - ((0.8 /*_EmissionSaturation*/)) * (0.0 /*_EmissionHueShiftEnabled*/));
				#if defined(PROP_EMISSIONMASK) || !defined(OPTIMIZER_ENABLED)
			...
			void applySubsurfaceScattering(in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiFragData poiFragData)
			{
				...
				SSS.a = 1 - SSS.a;
				#endif
				float3 vLTLight = poiLight.direction + poiMesh.normals[0] * (0.347 /*_SSSDistortion*/);
				float flTDot = pow(saturate(dot(poiCam.viewDir, -vLTLight)), (5.0 /*_SSSSpread*/)) * (0.25 /*_SSSStrength*/);
				#ifdef UNITY_PASS_FORWARDBASE
				float3 fLT = (flTDot) * saturate(SSS.a + - 1 * (-0.526 /*_SSSThicknessMod*/));
				#else
				float3 fLT = poiLight.additiveShadow * (flTDot) * saturate(SSS.a + - 1 * (-0.526 /*_SSSThicknessMod*/));
				#endif
				#if defined(POINT) || defined(SPOT)
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(1,1,1,1) * SSS.rgb * lerp(1, poiFragData.baseColor, (1.0 /*_SSSBaseColorMix*/));
				#endif
				poiLight.finalLightAdd += fLT * poiLight.directColor * float4(1,1,1,1) * SSS.rgb * poiLight.attenuation * lerp(1, poiFragData.baseColor, (1.0 /*_SSSBaseColorMix*/));
			}
			#endif
			...
			void MetallicAndSpecularFragDataInit(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness2 = (0.9 /*_MochieRoughnessMultiplier2*/);
				...
				#if defined(PROP_MOCHIEMETALLICMAPS) || !defined(OPTIMIZER_ENABLED)
				float4 PBRMaps = POI2D_SAMPLER_PAN_STOCHASTIC(_MochieMetallicMaps, _MainTex, poiUV(poiMesh.uv[(0.0 /*_MochieMetallicMapsUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (1.0 /*_MochieMetallicMapsStochastic*/));
			...
			void poiClearCoat(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				float smoothness = (0.95 /*_ClearCoatSmoothness*/);
				float reflectionMask = (1.0 /*_ClearCoatReflectionStrength*/);
				float specularMask = (1.0 /*_ClearCoatSpecularStrength*/);
				#if defined(PROP_CLEARCOATMAPS) || !defined(OPTIMIZER_ENABLED)
				float4 PBRMaps = POI2D_SAMPLER_PAN_STOCHASTIC(_ClearCoatMaps, _MainTex, poiUV(poiMesh.uv[(0.0 /*_ClearCoatMapsUV*/)], float4(1,1,0,0)), float4(0,0,0,0), (1.0 /*_ClearCoatMapsStochastic*/));
				...
				if ((1.0 /*_ClearCoatMaskInvert*/))
				{
					clearCoatMask = 1 - clearCoatMask;
				}
				if ((1.0 /*_ClearCoatSmoothnessMapInvert*/))
				{
					smoothness = 1 - smoothness;
				}
				...
				if ((1.0 /*_ClearCoatSpecularMaskInvert*/))
				{
					specularMask = 1 - specularMask;
				}
				#ifdef TPS_Penetrator
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#ifdef _RIM2STYLE_LILTOON
				#if defined(PROP_RIM2COLORTEX) || !defined(OPTIMIZER_ENABLED)
				float4 rim2ColorTex = POI2D_SAMPLER_PAN(_Rim2ColorTex, _MainTex, poiUV(poiMesh.uv[(0.0 /*_Rim2ColorTexUV*/)], float4(1,1,0,0)), float4(0,0,0,0));
				#else
				float4 rim2ColorTex = 1;
				#endif
				ApplyLiltoonRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, float4(1,1,1,1), float4(1,1,1,1), rim2ColorTex, (0.727 /*_Rim2MainStrength*/), (1.0 /*_Rim2NormalStrength*/), (0.038 /*_Rim2DirRange*/), (0.0 /*_Rim2IndirRange*/), (3.5 /*_Rim2FresnelPower*/), (1 /*_Rim2BackfaceMask*/), (0.821 /*_Rim2DirStrength*/), (0.5 /*_Rim2Border*/), (0.0 /*_Rim2Blur*/), (0.5 /*_Rim2IndirBorder*/), (0.1 /*_Rim2IndirBlur*/), (0.383 /*_Rim2ShadowMask*/), (1.0 /*_Rim2EnableLighting*/), (1.0 /*_Rim2VRParallaxStrength*/), (0.0 /*_Rim2GlobalMask*/), (2.0 /*_Rim2GlobalMaskBlendType*/), (0.0 /*_Rim2HueShiftEnabled*/), (0.0 /*_Rim2HueShift*/), (0.0 /*_Rim2HueShiftColorSpace*/), (0.0 /*_Rim2HueShiftSpeed*/), (0 /*_Rim2BlendMode*/));
				#endif
				#endif
				if ((1.0 /*_FXProximityColor*/))
				{
					float3 position = (1.0 /*_FXProximityColorType*/) ? poiMesh.worldPos : poiMesh.objectPosition;
					poiFragData.finalColor *= lerp(poiThemeColor(poiMods, float4(0.130239,0.130239,0.130239,1).rgb, (0.0 /*_FXProximityColorMinColorThemeIndex*/)), poiThemeColor(poiMods, float4(1,1,1,1).rgb, (0.0 /*_FXProximityColorMaxColorThemeIndex*/)), smoothstep((0.0 /*_FXProximityColorMinDistance*/), (0.11 /*_FXProximityColorMaxDistance*/), distance(position, poiCam.worldPos)));
					if ((0.0 /*_FXProximityColorBackFace*/))
					{
						poiFragData.finalColor = lerp(poiFragData.finalColor * float4(0.130239,0.130239,0.130239,1).rgb, poiFragData.finalColor, saturate(poiMesh.isFrontFace));
					}
				}
