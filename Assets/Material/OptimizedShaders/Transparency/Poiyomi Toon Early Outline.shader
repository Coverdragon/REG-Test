Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon Outline Early/2d0f7019a847e8e43859bd693fab63f9"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void initPoiAudioLink(inout PoiMods poiMods)
			{
				...
				{
					poiMods.audioLinkAvailable = true;
					poiMods.audioLink[0] = float4(0.5,0.255,0.392,0.118).x;
					poiMods.audioLink[1] = float4(0.5,0.255,0.392,0.118).y;
					poiMods.audioLink[2] = float4(0.5,0.255,0.392,0.118).z;
					poiMods.audioLink[3] = float4(0.5,0.255,0.392,0.118).w;
				}
			}
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAlphaOptions(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					float holoRim = saturate(1 - smoothstep(min((0.205 /*_AlphaFresnelSharpness*/), (0.706 /*_AlphaFresnelWidth*/)), (0.706 /*_AlphaFresnelWidth*/), (poiCam.vDotN)));
					holoRim = abs(lerp(1, holoRim, (0.811 /*_AlphaFresnelAlpha*/)));
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float3 normal0 = lerp(poiMesh.normals[0], poiMesh.normals[1], (0.0 /*_MatcapNormal*/));
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (3.0 /*_MatcapUVMode*/), (0.0 /*_MatcapUVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_MatcapRotation*/), (0.79 /*_MatcapBorder*/), normal0, poiCam, poiLight, poiMesh, (0.0 /*_MatcapNormal*/), matcapALD);
				...
				#endif
				matcapIntensity = (1.5 /*_MatcapIntensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
				...
				{
					matcap.rgb = hueShift(matcap.rgb, (0.521 /*_MatcapHueShift*/) + _Time.x * (0.0 /*_MatcapHueShiftSpeed*/), (0.0 /*_MatcapHueShiftColorSpace*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (1.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.469 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.649 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				float3 normal1 = lerp(poiMesh.normals[0], poiMesh.normals[1], (0.0 /*_Matcap2Normal*/));
				#if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (3.0 /*_Matcap2UVMode*/), (0.0 /*_Matcap2UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap2Rotation*/), (0.79 /*_Matcap2Border*/), normal1, poiCam, poiLight, poiMesh, (0.0 /*_Matcap2Normal*/), matcapALD);
				...
				#endif
				poiFragData.alpha *= lerp(1, matcap2.a, matcap2Mask * (1.0 /*_Matcap2AlphaOverride*/));
				if ((0.0 /*_Matcap2HueShiftEnabled*/))
				{
					matcap2.rgb = hueShift(matcap2.rgb, (0.521 /*_Matcap2HueShift*/) + _Time.x * (0.0 /*_Matcap2HueShiftSpeed*/), (0.0 /*_Matcap2HueShiftColorSpace*/));
				}
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (0.782 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.649 /*_Matcap2LightMask*/), (2.0 /*_Matcap2MaskGlobalMask*/), (0.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			#ifdef POI_AUDIOLINK
			...
			void ApplyAudioLinkDecal(in PoiMesh poiMesh, inout PoiFragData poiFragData, in PoiMods poiMods)
			{
				...
				float sn = sin(theta);
				uv = float2((uv.x - decalCenter.x) * cs - (uv.y - decalCenter.y) * sn + decalCenter.x, (uv.x - decalCenter.x) * sn + (uv.y - decalCenter.y) * cs + decalCenter.y);
				uv = remap(uv, float2(0, 0) - float4(0,0,0,0).xz / 2 + float4(0,0,1,1), float4(0,0,0,0).yw / 2 + float4(0,0,1,1), float2(0, 0), float2(1, 1));
				...
				float3 emissionColor = lerp(lowColor * (8.0 /*_ALDecalLowEmission*/), midColor * (6.0 /*_ALDecalMidEmission*/), saturate(volumeColorSrc * 2));
				emissionColor = lerp(emissionColor, highColor * (4.5 /*_ALDecalHighEmission*/), saturate(volumeColorSrc * 2 - 1));
				#if defined(POI_PASS_BASE) || defined(POI_PASS_ADD)
				poiFragData.emission += emissionColor * audioLinkValue;
				poiFragData.baseColor.rgb = lerp(poiFragData.baseColor, customBlend(poiFragData.baseColor, volumeColor * colorAndMask.rgb, (0.0 /*_ALDecalBlendType*/)), saturate((0.0 /*_ALDecalBlendAlpha*/) * audioLinkValue));
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.4725527,0.4725527,0.4725527,1).rgb, (0.0 /*_ColorThemeIndex*/));
