Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon/30384f004346d2c488ab916a70648e63"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				float3 heightOffset = (tex2Dlod(_VertexManipulationHeightMask, float4(poiUV(vertexUV(v, (1.0 /*_VertexManipulationHeightMaskUV*/)), float4(0.3,0.3,0,0)) + float4(3.5,0.34,0,0) * _Time.x, 0, 0))[(0.0 /*_VertexManipulationHeightMaskChannel*/)] - (0.575 /*_VertexManipulationHeightBias*/)) * ((0.1 /*_VertexManipulationHeight*/) + ALHeight) * o.normal;
				#else
				float3 heightOffset = ((0.1 /*_VertexManipulationHeight*/) + ALHeight) * o.normal;
				#endif
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalRotation = (340.0 /*_DecalRotation*/);
				Decal0.m_DecalScale = float4(0.08,0.17,0,0);
				Decal0.m_DecalSideOffset = float4(0,0,0,0);
				Decal0.m_DecalPosition = float4(0.68,0.2,0,0);
				...
				Decal1.m_DecalRotation = (22.0 /*_DecalRotation1*/);
				Decal1.m_DecalScale = float4(0.08,0.17,0,0);
				Decal1.m_DecalSideOffset = float4(0,0,0,0);
				Decal1.m_DecalPosition = float4(0.55,0.2,0,0);
				...
				Decal2.m_DecalScale = float4(0.08,0.17,0,0);
				Decal2.m_DecalSideOffset = float4(0,0,0,0);
				Decal2.m_DecalPosition = float4(0.55,0.2,0,0);
				...
				Decal3.m_DecalRotation = (340.0 /*_DecalRotation3*/);
				Decal3.m_DecalScale = float4(0.08,0.17,0,0);
				Decal3.m_DecalSideOffset = float4(0,0,0,0);
				Decal3.m_DecalPosition = float4(0.68,0.2,0,0);
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float3 normal0 = lerp(poiMesh.normals[0], poiMesh.normals[1], (0.538 /*_MatcapNormal*/));
				#ifdef POI_MATCAP0_CUSTOM_NORMAL
				#if defined(PROP_MATCAP0NORMALMAP) || !defined(OPTIMIZER_ENABLED)
				normal0 = calculateNormal(poiMesh.normals[(0.538 /*_MatcapNormal*/)], poiMesh, _Matcap0NormalMap, float4(1,1,0,0), float4(0,0,0,0), (0.0 /*_Matcap0NormalMapUV*/), (2.12 /*_Matcap0NormalMapScale*/));
				#endif
				#endif
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(7,0,0,0).xy, (3.0 /*_MatcapUVMode*/), (0.0 /*_MatcapUVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_MatcapRotation*/), (0.42 /*_MatcapBorder*/), normal0, poiCam, poiLight, poiMesh, (0.538 /*_MatcapNormal*/), matcapALD);
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					...
					float matcapSmoothness = (0.0 /*_MatcapSmoothness*/);
					if ((0.0 /*_MatcapMaskSmoothnessApply*/))
					{
						#if defined(PROP_MATCAPMASK) || !defined(OPTIMIZER_ENABLED)
						matcapSmoothness *= POI2D_SAMPLER_PAN(_MatcapMask, _MainTex, poiUV(poiMesh.uv[(0.0 /*_MatcapMaskUV*/)], float4(1,1,0,0)), float4(0,0,0,0))[(0.0 /*_MatcapMaskSmoothnessChannel*/)];
						#endif
					}
				...
				{
					matcapMask = lerp(0, matcapMask * TPSBufferedDepth(poiMesh.localPos, poiMesh.vertexColor), (0.0 /*_MatcapTPSMaskStrength*/));
				}
				#endif
				poiFragData.alpha *= lerp(1, matcap.a, matcapMask * (1.0 /*_MatcapAlphaOverride*/));
				if ((0.0 /*_MatcapHueShiftEnabled*/))
				{
					matcap.rgb = hueShift(matcap.rgb, (0.521 /*_MatcapHueShift*/) + _Time.x * (3.0 /*_MatcapHueShiftSpeed*/), (1.0 /*_MatcapHueShiftColorSpace*/));
				}
				...
				#if defined(PROP_MATCAP4) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (0.0 /*_Matcap4UVMode*/), (0.0 /*_Matcap4UVToBlend*/), float4(0,0,0,0).xy, (0.0 /*_Matcap4Rotation*/), (0.43 /*_Matcap4Border*/), normal3, poiCam, poiLight, poiMesh, (1.0 /*_Matcap4Normal*/), matcapALD);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap4Add*/), (0.0 /*_Matcap4AddToLight*/), (0.0 /*_Matcap4Multiply*/), (0.0 /*_Matcap4Replace*/), (1.0 /*_Matcap4Mixed*/), (0.0 /*_Matcap4Screen*/), matcap4, matcap4Mask, (0.0 /*_Matcap4EmissionStrength*/), (0.0 /*_Matcap4LightMask*/), (0.0 /*_Matcap4MaskGlobalMask*/), (2.0 /*_Matcap4MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			#ifdef POI_AUDIOLINK
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				{
					percepRough = GSAA_Filament(poiMesh.normals[(0.999 /*_PBRNormalSelect*/)], percepRough, (0.15 /*_PoiGSAAVariance*/), (0.1 /*_PoiGSAAThreshold*/));
					if ((0.0 /*_Specular2ndLayer*/) == 1 && (1.0 /*_MochieSpecularStrength2*/) > 0)
					{
						percepRough2 = GSAA_Filament(poiMesh.normals[(0.999 /*_PBRNormalSelect*/)], percepRough2, (0.15 /*_PoiGSAAVariance*/), (0.1 /*_PoiGSAAThreshold*/));
					}
				}
				...
				float pbrNDotL = lerp(poiLight.vertexNDotL, poiLight.nDotL, (0.999 /*_PBRNormalSelect*/));
				float pbrNDotV = lerp(poiLight.vertexNDotV, poiLight.nDotV, (0.999 /*_PBRNormalSelect*/));
				float pbrNDotH = lerp(poiLight.vertexNDotH, poiLight.nDotH, (0.999 /*_PBRNormalSelect*/));
				float3 pbrReflectionDir = lerp(poiCam.vertexReflectionDir, poiCam.reflectionDir, (0.999 /*_PBRNormalSelect*/));
				...
				if (poiFragData.toggleVertexLights)
				{
					...
					for (int index = 0; index < 4; index++)
					{
						fresnelTerm = 1;
						specularTerm = 1;
						float pbrVDotNL = lerp(poiLight.vertexVDotNL[index], poiLight.vDotNL[index], (0.999 /*_PBRNormalSelect*/));
						float pbrVDotNH = lerp(poiLight.vertexVDotNH[index], poiLight.vDotNH[index], (0.999 /*_PBRNormalSelect*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), (0.86 /*_BumpScale*/));
				#else
