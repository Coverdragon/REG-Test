Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon/8788f12b19dfe254bbebd1c53eefc837"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				if((0.0 /*_UDIMDiscardMode*/) == 0) // Discard Vertices instead of just pixels
				{
					...
					(udim.x >= 2 && udim.x < 3),
					(udim.x >= 3 && udim.x < 4));
					isDiscarded += (udim.y >= 0 && udim.y < 1) * dot(float4((1.0 /*_UDIMDiscardRow0_0*/), (1.0 /*_UDIMDiscardRow0_1*/), (1.0 /*_UDIMDiscardRow0_2*/), (1.0 /*_UDIMDiscardRow0_3*/)), xMask);
					isDiscarded += (udim.y >= 1 && udim.y < 2) * dot(float4((1.0 /*_UDIMDiscardRow1_0*/), (1.0 /*_UDIMDiscardRow1_1*/), (1.0 /*_UDIMDiscardRow1_2*/), (1.0 /*_UDIMDiscardRow1_3*/)), xMask);
					isDiscarded += (udim.y >= 2 && udim.y < 3) * dot(float4((1.0 /*_UDIMDiscardRow2_0*/), (1.0 /*_UDIMDiscardRow2_1*/), (1.0 /*_UDIMDiscardRow2_2*/), (1.0 /*_UDIMDiscardRow2_3*/)), xMask);
					isDiscarded += (udim.y >= 3 && udim.y < 4) * dot(float4((1.0 /*_UDIMDiscardRow3_0*/), (1.0 /*_UDIMDiscardRow3_1*/), (1.0 /*_UDIMDiscardRow3_2*/), (1.0 /*_UDIMDiscardRow3_3*/)), xMask);
