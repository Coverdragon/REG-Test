Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon/38ce9b91eff057444b4f717396ffb860"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				float smoothness = (0.466 /*_MochieRoughnessMultiplier*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				clip(poiFragData.alpha - (0.378 /*_Cutoff*/));
