Shader "Hidden/Locked/.poiyomi/Old Versions/9.0/Poiyomi Toon Outline Early/3809f2262b975db43b67f57fd0c48841"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyAlphaOptions(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				{
					float holoRim = saturate(1 - smoothstep(min((0.227 /*_AlphaFresnelSharpness*/), (0.364 /*_AlphaFresnelWidth*/)), (0.364 /*_AlphaFresnelWidth*/), (poiCam.vDotN)));
					holoRim = abs(lerp(1, holoRim, (0.242 /*_AlphaFresnelAlpha*/)));
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				float3 normal0 = lerp(poiMesh.normals[0], poiMesh.normals[1], (0.083 /*_MatcapNormal*/));
				#if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
				getMatcapUV(matcapUV, float4(0,0,0,0).xy, (3.0 /*_MatcapUVMode*/), (0.0 /*_MatcapUVToBlend*/), float4(0,0.421,0,0).xy, (0.0 /*_MatcapRotation*/), (0.79 /*_MatcapBorder*/), normal0, poiCam, poiLight, poiMesh, (0.083 /*_MatcapNormal*/), matcapALD);
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.235 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.469 /*_MatcapScreen*/), matcap, matcapMask, (0.15 /*_MatcapEmissionStrength*/), (0.649 /*_MatcapLightMask*/), (1.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			#ifdef POI_AUDIOLINK
