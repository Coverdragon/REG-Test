Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/488e09c83698eaf40ac92af44cb1ed03" {
	Properties {
		...
		[Vector2] [HideInInspector] _VertexBasicsMaskUVPan ("Panning", Vector) = (0,0,0,0)
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3)] [HideInInspector] VertexBasicsMaskUV ("UV", Float) = 0
		...
		[Vector2] [HideInInspector] _VertexManipulationHeightMaskPan ("Panning", Vector) = (0,0,0,0)
		[Enum(UV0, 0, UV1, 1, UV2, 2, UV3, 3)] [HideInInspector] _VertexManipulationHeightMaskUV ("UV", Float) = 0
		[Enum(R, 0, G, 1, B, 2, A, 3)] [HideInInspector] _VertexManipulationHeightMapChannel ("Map Channel", Float) = 0
