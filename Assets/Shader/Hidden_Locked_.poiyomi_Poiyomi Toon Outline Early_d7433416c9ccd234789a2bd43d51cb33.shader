Shader "Hidden/Locked/.poiyomi/Poiyomi Toon Outline Early/d7433416c9ccd234789a2bd43d51cb33" {
	Properties {
		...
		_MatcapColor_ValveAlt ("Color--{reference_property:_MatcapColorThemeIndex}", Vector) = (1,1,1,1)
		...
		_Matcap2Color_ValveAlt ("Color--{reference_property:_Matcap2ColorThemeIndex}", Vector) = (1,1,1,1)
