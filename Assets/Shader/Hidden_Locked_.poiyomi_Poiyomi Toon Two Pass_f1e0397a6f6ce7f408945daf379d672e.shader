Shader "Hidden/Locked/.poiyomi/Poiyomi Toon Two Pass/f1e0397a6f6ce7f408945daf379d672e" {
	Properties {
		...
		_TwoPassColor ("Color & Alpha--{reference_property:_TwoPassColorThemeIndex}", Vector) = (1,1,1,1)
		[ThryWideEnum(Off, 0, Theme Color 0, 1, Theme Color 1, 2, Theme Color 2, 3, Theme Color 3, 4, ColorChord 0, 5, ColorChord 1, 6, ColorChord 2, 7, ColorChord 3, 8, AL Theme 0, 9, AL Theme 1, 10, AL Theme 2, 11, AL Theme 3, 12)] [HideInInspector] _TwoPassColorThemeIndex ("", Float) = 0
		_TwoPassAlphaCutoff ("Alpha Cutoff", Range(0, 1.001)) = 0.5
		[ToggleUI] _TwoPassAlphaCutoffInvert ("Invert Alpha Cutoff", Float) = 0
		[ToggleUI] [HideInInspector] _AlphaPremultiply2 ("Alpha Premultiply", Float) = 0
		...
		_Matcap3Color_HoneyPotTAlt ("Color--{reference_property:_Matcap3ColorThemeIndex}", Vector) = (1,1,1,1)
		...
		[DoNotAnimate] [Enum(Off, 0, On, 1)] _ZWrite2 ("ZWrite", Float) = 1
		[DoNotAnimate] [ThryMask(Thry.ColorMaskFlags)] _ColorMask2 ("Color Mask", Float) = 15
		...
		[DoNotAnimate] [Enum(Thry.BlendOp)] _BlendOp2 ("RGB Blend Op", Float) = 0
		[DoNotAnimate] [Enum(UnityEngine.Rendering.BlendMode)] _SrcBlend2 ("RGB Source Blend", Float) = 1
		[DoNotAnimate] [Enum(UnityEngine.Rendering.BlendMode)] _DstBlend2 ("RGB Destination Blend", Float) = 0
		[DoNotAnimate] [Space] [ThryHeaderLabel(Additive Blending, 13)] [DoNotAnimate] [Enum(Thry.BlendOp)] _AddBlendOp2 ("RGB Blend Op", Float) = 4
		[DoNotAnimate] [Enum(UnityEngine.Rendering.BlendMode)] _AddSrcBlend2 ("RGB Source Blend", Float) = 1
		[DoNotAnimate] [Enum(UnityEngine.Rendering.BlendMode)] _AddDstBlend2 ("RGB Destination Blend", Float) = 1
		[DoNotAnimate] [HideInInspector] m_start_alphaBlending2 ("2nd Pass Advanced Alpha Blending", Float) = 0
		[DoNotAnimate] [Enum(Thry.BlendOp)] _BlendOpAlpha2 ("Alpha Blend Op", Float) = 0
		[DoNotAnimate] [Enum(UnityEngine.Rendering.BlendMode)] _SrcBlendAlpha2 ("Alpha Source Blend", Float) = 1
		[DoNotAnimate] [Enum(UnityEngine.Rendering.BlendMode)] _DstBlendAlpha2 ("Alpha Destination Blend", Float) = 10
		[DoNotAnimate] [Space] [ThryHeaderLabel(Additive Blending, 13)] [DoNotAnimate] [Enum(Thry.BlendOp)] _AddBlendOpAlpha2 ("Alpha Blend Op", Float) = 4
		[DoNotAnimate] [Enum(UnityEngine.Rendering.BlendMode)] _AddSrcBlendAlpha2 ("Alpha Source Blend", Float) = 0
		[DoNotAnimate] [Enum(UnityEngine.Rendering.BlendMode)] _AddDstBlendAlpha2 ("Alpha Destination Blend", Float) = 1
