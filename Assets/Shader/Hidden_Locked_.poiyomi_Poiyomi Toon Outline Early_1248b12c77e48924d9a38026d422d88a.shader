Shader "Hidden/Locked/.poiyomi/Poiyomi Toon Outline Early/1248b12c77e48924d9a38026d422d88a" {
	Properties {
		...
		[ThryWideEnum(Texture, 0, Vertex Color, 1)] _RGBMaskType ("Mask Type", Float) = 0
		...
		[Vector2] [HideInInspector] _RGBMaskPan ("Panning", Vector) = (0,0,0,0)
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _RGBMaskUV ("UV", Float) = 0
		...
		[Vector2] [HideInInspector] _RGBAMetallicMapsPan ("Panning", Vector) = (0,0,0,0)
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _RGBAMetallicMapsUV ("UV", Float) = 0
		[ToggleUI] [HideInInspector] _RGBAMetallicMapsStochastic ("Stochastic Sampling", Float) = 0
		[ToggleUI] [HideInInspector] _RGBARedMetallicInvert ("Invert R", Float) = 0
		[ToggleUI] [HideInInspector] _RGBAGreenMetallicInvert ("Invert G", Float) = 0
		[ToggleUI] [HideInInspector] _RGBABlueMetallicInvert ("Invert B", Float) = 0
		[ToggleUI] [HideInInspector] _RGBAAlphaMetallicInvert ("Invert A", Float) = 0
		...
		[Vector2] [HideInInspector] _RGBASmoothnessMapsPan ("Panning", Vector) = (0,0,0,0)
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _RGBASmoothnessMapsUV ("UV", Float) = 0
		[ToggleUI] [HideInInspector] _RGBASmoothnessMapsStochastic ("Stochastic Sampling", Float) = 0
		[ToggleUI] [HideInInspector] _RGBARedSmoothnessInvert ("Invert R", Float) = 0
		[ToggleUI] [HideInInspector] _RGBAGreenSmoothnessInvert ("Invert G", Float) = 0
		[ToggleUI] [HideInInspector] _RGBABlueSmoothnessInvert ("Invert B", Float) = 0
		[ToggleUI] [HideInInspector] _RGBAAlphaSmoothnessInvert ("Invert A", Float) = 0
		[HideInInspector] s_start_RGBRed ("Red--{reference_property:_RGBARedEnable,persistent_expand:true,default_expand:false}", Float) = 0
		[ToggleUI] [HideInInspector] _RGBARedEnable ("Enable Red", Float) = 0
		...
		_RedColor ("Color--{reference_property:_RedColorThemeIndex}", Vector) = (1,1,1,1)
		[ThryWideEnum(Off, 0, Theme Color 0, 1, Theme Color 1, 2, Theme Color 2, 3, Theme Color 3, 4, ColorChord 0, 5, ColorChord 1, 6, ColorChord 2, 7, ColorChord 3, 8, AL Theme 0, 9, AL Theme 1, 10, AL Theme 2, 11, AL Theme 3, 12)] [HideInInspector] _RedColorThemeIndex ("", Float) = 0
		...
		[Vector2] [HideInInspector] _RedTexturePan ("Panning", Vector) = (0,0,0,0)
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _RedTextureUV ("UV", Float) = 0
		[ToggleUI] [HideInInspector] _RedTextureStochastic ("Stochastic Sampling", Float) = 0
		[HideInInspector] _RedAlphaAdd ("Alpha Add", Range(-1, 1)) = 0
		[Enum(R, 0, G, 1, B, 2, A, 3)] [HideInInspector] _RgbRedMaskChannel ("Mask Channel", Float) = 0
		[ThryWideEnum(Off, 0, 1R, 1, 1G, 2, 1B, 3, 1A, 4, 2R, 5, 2G, 6, 2B, 7, 2A, 8, 3R, 9, 3G, 10, 3B, 11, 3A, 12, 4R, 13, 4G, 14, 4B, 15, 4A, 16)] [HideInInspector] _RgbRedGlobalMaskChannel ("Global Mask--{reference_property:_RgbRedGlobalMaskBlendType}", Float) = 0
		[ThryWideEnum(Add, 7, Subtract, 1, Multiply, 2, Divide, 3, Min, 4, Max, 5, Average, 6, Replace, 0)] [HideInInspector] _RgbRedGlobalMaskBlendType ("Blending", Range(0, 1)) = 2
		...
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _RgbNormalRUV ("UV", Float) = 0
		[ToggleUI] [HideInInspector] _RgbNormalRStochastic ("Stochastic Sampling", Float) = 0
		[Enum(R, 0, G, 1, B, 2, A, 3)] [HideInInspector] _RgbNormalRMaskChannel ("Mask Channel", Float) = 0
		[Enum(Replace, 0, Blend All, 1, Blend Base Normal, 2)] [HideInInspector] _RgbNormalRedBlendMode ("Blend Mode", Float) = 0
		[ThryWideEnum(Off, 0, 1R, 1, 1G, 2, 1B, 3, 1A, 4, 2R, 5, 2G, 6, 2B, 7, 2A, 8, 3R, 9, 3G, 10, 3B, 11, 3A, 12, 4R, 13, 4G, 14, 4B, 15, 4A, 16)] [HideInInspector] _RgbNormalRGlobalMaskChannel ("Global Mask--{reference_property:_RgbNormalRGlobalMaskBlendType}", Float) = 0
		[ThryWideEnum(Add, 7, Subtract, 1, Multiply, 2, Divide, 3, Min, 4, Max, 5, Average, 6, Replace, 0)] [HideInInspector] _RgbNormalRGlobalMaskBlendType ("Blending", Range(0, 1)) = 2
		...
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] _RGBARedPBRUV ("UV--{condition_showS:(_RGBARedPBRSplitMaskSample==1&&_RGBAPBRRedEnabled==1)}", Float) = 0
		...
		[ToggleUI] [HideInInspector] _RGBAGreenEnable ("Enable Green", Float) = 0
		...
		_GreenColor ("Color--{reference_property:_GreenColorThemeIndex}", Vector) = (1,1,1,1)
		[ThryWideEnum(Off, 0, Theme Color 0, 1, Theme Color 1, 2, Theme Color 2, 3, Theme Color 3, 4, ColorChord 0, 5, ColorChord 1, 6, ColorChord 2, 7, ColorChord 3, 8, AL Theme 0, 9, AL Theme 1, 10, AL Theme 2, 11, AL Theme 3, 12)] [HideInInspector] _GreenColorThemeIndex ("", Float) = 0
		...
		[Vector2] [HideInInspector] _GreenTexturePan ("Panning", Vector) = (0,0,0,0)
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _GreenTextureUV ("UV", Float) = 0
		[ToggleUI] [HideInInspector] _GreenTextureStochastic ("Stochastic Sampling", Float) = 0
		[HideInInspector] _GreenAlphaAdd ("Alpha Add", Range(-1, 1)) = 0
		[Enum(R, 0, G, 1, B, 2, A, 3)] [HideInInspector] _RgbGreenMaskChannel ("Mask Channel", Float) = 1
		[ThryWideEnum(Off, 0, 1R, 1, 1G, 2, 1B, 3, 1A, 4, 2R, 5, 2G, 6, 2B, 7, 2A, 8, 3R, 9, 3G, 10, 3B, 11, 3A, 12, 4R, 13, 4G, 14, 4B, 15, 4A, 16)] [HideInInspector] _RgbGreenGlobalMaskChannel ("Global Mask--{reference_property:_RgbGreenGlobalMaskBlendType}", Float) = 0
		[ThryWideEnum(Add, 7, Subtract, 1, Multiply, 2, Divide, 3, Min, 4, Max, 5, Average, 6, Replace, 0)] [HideInInspector] _RgbGreenGlobalMaskBlendType ("Blending", Range(0, 1)) = 2
		...
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _RgbNormalGUV ("UV", Float) = 0
		[ToggleUI] [HideInInspector] _RgbNormalGStochastic ("Stochastic Sampling", Float) = 0
		[Enum(R, 0, G, 1, B, 2, A, 3)] [HideInInspector] _RgbNormalGMaskChannel ("Mask Channel", Float) = 1
		[Enum(Replace, 0, Blend All, 1, Blend Base Normal, 2)] [HideInInspector] _RgbNormalGreenBlendMode ("Blend Mode", Float) = 0
		[ThryWideEnum(Off, 0, 1R, 1, 1G, 2, 1B, 3, 1A, 4, 2R, 5, 2G, 6, 2B, 7, 2A, 8, 3R, 9, 3G, 10, 3B, 11, 3A, 12, 4R, 13, 4G, 14, 4B, 15, 4A, 16)] [HideInInspector] _RgbNormalGGlobalMaskChannel ("Global Mask--{reference_property:_RgbNormalGGlobalMaskBlendType}", Float) = 0
		[ThryWideEnum(Add, 7, Subtract, 1, Multiply, 2, Divide, 3, Min, 4, Max, 5, Average, 6, Replace, 0)] [HideInInspector] _RgbNormalGGlobalMaskBlendType ("Blending", Range(0, 1)) = 2
		...
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] _RGBAGreenPBRUV ("UV--{condition_showS:(_RGBAGreenPBRSplitMaskSample==1&&_RGBAPBRGreenEnabled==1)}", Float) = 0
		...
		[ToggleUI] [HideInInspector] _RGBABlueEnable ("Enable Blue", Float) = 0
		...
		_BlueColor ("Color--{reference_property:_BlueColorThemeIndex}", Vector) = (1,1,1,1)
		[ThryWideEnum(Off, 0, Theme Color 0, 1, Theme Color 1, 2, Theme Color 2, 3, Theme Color 3, 4, ColorChord 0, 5, ColorChord 1, 6, ColorChord 2, 7, ColorChord 3, 8, AL Theme 0, 9, AL Theme 1, 10, AL Theme 2, 11, AL Theme 3, 12)] [HideInInspector] _BlueColorThemeIndex ("", Float) = 0
		...
		[Vector2] [HideInInspector] _BlueTexturePan ("Panning", Vector) = (0,0,0,0)
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _BlueTextureUV ("UV", Float) = 0
		[ToggleUI] [HideInInspector] _BlueTextureStochastic ("Stochastic Sampling", Float) = 0
		[HideInInspector] _BlueAlphaAdd ("Alpha Add", Range(-1, 1)) = 0
		[Enum(R, 0, G, 1, B, 2, A, 3)] [HideInInspector] _RgbBlueMaskChannel ("Mask Channel", Float) = 2
		[ThryWideEnum(Off, 0, 1R, 1, 1G, 2, 1B, 3, 1A, 4, 2R, 5, 2G, 6, 2B, 7, 2A, 8, 3R, 9, 3G, 10, 3B, 11, 3A, 12, 4R, 13, 4G, 14, 4B, 15, 4A, 16)] [HideInInspector] _RgbBlueGlobalMaskChannel ("Global Mask--{reference_property:_RgbBlueGlobalMaskBlendType}", Float) = 0
		[ThryWideEnum(Add, 7, Subtract, 1, Multiply, 2, Divide, 3, Min, 4, Max, 5, Average, 6, Replace, 0)] [HideInInspector] _RgbBlueGlobalMaskBlendType ("Blending", Range(0, 1)) = 2
		...
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _RgbNormalBUV ("UV", Float) = 0
		[ToggleUI] [HideInInspector] _RgbNormalBStochastic ("Stochastic Sampling", Float) = 0
		[Enum(R, 0, G, 1, B, 2, A, 3)] [HideInInspector] _RgbNormalBMaskChannel ("Mask Channel", Float) = 2
		[Enum(Replace, 0, Blend All, 1, Blend Base Normal, 2)] [HideInInspector] _RgbNormalBlueBlendMode ("Blend Mode", Float) = 0
		[ThryWideEnum(Off, 0, 1R, 1, 1G, 2, 1B, 3, 1A, 4, 2R, 5, 2G, 6, 2B, 7, 2A, 8, 3R, 9, 3G, 10, 3B, 11, 3A, 12, 4R, 13, 4G, 14, 4B, 15, 4A, 16)] [HideInInspector] _RgbNormalBGlobalMaskChannel ("Global Mask--{reference_property:_RgbNormalBGlobalMaskBlendType}", Float) = 0
		[ThryWideEnum(Add, 7, Subtract, 1, Multiply, 2, Divide, 3, Min, 4, Max, 5, Average, 6, Replace, 0)] [HideInInspector] _RgbNormalBGlobalMaskBlendType ("Blending", Range(0, 1)) = 2
		...
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] _RGBABluePBRUV ("UV--{condition_showS:(_RGBABluePBRSplitMaskSample==1&&_RGBAPBRBlueEnabled==1)}", Float) = 0
		...
		[ToggleUI] [HideInInspector] _RGBAAlphaEnable ("Enable Alpha", Float) = 0
		...
		_AlphaColor ("Color--{reference_property:_AlphaColorThemeIndex}", Vector) = (1,1,1,1)
		[ThryWideEnum(Off, 0, Theme Color 0, 1, Theme Color 1, 2, Theme Color 2, 3, Theme Color 3, 4, ColorChord 0, 5, ColorChord 1, 6, ColorChord 2, 7, ColorChord 3, 8, AL Theme 0, 9, AL Theme 1, 10, AL Theme 2, 11, AL Theme 3, 12)] [HideInInspector] _AlphaColorThemeIndex ("", Float) = 0
		...
		[Vector2] [HideInInspector] _AlphaTexturePan ("Panning", Vector) = (0,0,0,0)
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _AlphaTextureUV ("UV", Float) = 0
		[ToggleUI] [HideInInspector] _AlphaTextureStochastic ("Stochastic Sampling", Float) = 0
		[HideInInspector] _AlphaAlphaAdd ("Alpha Add", Range(-1, 1)) = 0
		[Enum(R, 0, G, 1, B, 2, A, 3)] [HideInInspector] _RgbAlphaMaskChannel ("Mask Channel", Float) = 3
		[ThryWideEnum(Off, 0, 1R, 1, 1G, 2, 1B, 3, 1A, 4, 2R, 5, 2G, 6, 2B, 7, 2A, 8, 3R, 9, 3G, 10, 3B, 11, 3A, 12, 4R, 13, 4G, 14, 4B, 15, 4A, 16)] [HideInInspector] _RgbAlphaGlobalMaskChannel ("Global Mask--{reference_property:_RgbAlphaGlobalMaskBlendType}", Float) = 0
		[ThryWideEnum(Add, 7, Subtract, 1, Multiply, 2, Divide, 3, Min, 4, Max, 5, Average, 6, Replace, 0)] [HideInInspector] _RgbAlphaGlobalMaskBlendType ("Blending", Range(0, 1)) = 2
		...
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _RgbNormalAUV ("UV", Float) = 0
		[ToggleUI] [HideInInspector] _RgbNormalAStochastic ("Stochastic Sampling", Float) = 0
		[Enum(R, 0, G, 1, B, 2, A, 3)] [HideInInspector] _RgbNormalAMaskChannel ("Mask Channel", Float) = 3
		[Enum(Replace, 0, Blend All, 1, Blend Base Normal, 2)] [HideInInspector] _RgbNormalAlphaBlendMode ("Blend Mode", Float) = 0
		[ThryWideEnum(Off, 0, 1R, 1, 1G, 2, 1B, 3, 1A, 4, 2R, 5, 2G, 6, 2B, 7, 2A, 8, 3R, 9, 3G, 10, 3B, 11, 3A, 12, 4R, 13, 4G, 14, 4B, 15, 4A, 16)] [HideInInspector] _RgbNormalAGlobalMaskChannel ("Global Mask--{reference_property:_RgbNormalAGlobalMaskBlendType}", Float) = 0
		[ThryWideEnum(Add, 7, Subtract, 1, Multiply, 2, Divide, 3, Min, 4, Max, 5, Average, 6, Replace, 0)] [HideInInspector] _RgbNormalAGlobalMaskBlendType ("Blending", Range(0, 1)) = 2
		...
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] _RGBAAlphaPBRUV ("UV--{condition_showS:(_RGBAAlphaPBRSplitMaskSample==1&&_RGBAPBRAlphaEnabled==1)}", Float) = 0
		...
		_Matcap3Color_BodyAltColortest ("Color--{reference_property:_Matcap3ColorThemeIndex}", Vector) = (1,1,1,1)
		...
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _EmissionMaskUV ("UV", Float) = 0
		[Enum(R, 0, G, 1, B, 2, A, 3)] [HideInInspector] _EmissionMaskChannel ("Channel", Float) = 0
		[ToggleUI] [HideInInspector] _EmissionMaskInvert ("Invert", Float) = 0
		[ThryWideEnum(Off, 0, 1R, 1, 1G, 2, 1B, 3, 1A, 4, 2R, 5, 2G, 6, 2B, 7, 2A, 8, 3R, 9, 3G, 10, 3B, 11, 3A, 12, 4R, 13, 4G, 14, 4B, 15, 4A, 16)] [HideInInspector] _EmissionMask0GlobalMask ("Global Mask--{reference_property:_EmissionMask0GlobalMaskBlendType}", Float) = 0
		...
		[ThryWideEnum(UV0, 0, UV1, 1, UV2, 2, UV3, 3, Panosphere, 4, World Pos, 5, Local Pos, 8, Polar UV, 6, Distorted UV, 7, Matcap, 9)] [HideInInspector] _EmissionMapUV ("UV", Float) = 0
		...
		[ToggleUI] [HideInInspector] _EmissionHueShiftEnabled ("Hue Shift", Float) = 0
		...
		[ToggleUI] [HideInInspector] _EmissionCenterOutEnabled ("Center Out", Float) = 0
		...
		[ToggleUI] [HideInInspector] _EnableGITDEmission ("Light Based", Float) = 0
		...
		[ToggleUI] [HideInInspector] _EmissionBlinkingEnabled ("Blinking", Float) = 0
		...
		[ToggleUI] [HideInInspector] _ScrollingEmission ("Scrolling", Float) = 0
