Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/3eee2eaff027f0341b459b64a3be4d31"
{
	Properties
	{
		...
		[ThryMultiFloats(true, _UDIMDiscardRow3_1_BodyDiffV2, _UDIMDiscardRow3_2_BodyDiffV2, _UDIMDiscardRow3_3_BodyDiffV2)] _UDIMDiscardRow3_0_BodyDiffV2("v = 3", Float) = 0
		[HideInInspector] _UDIMDiscardRow3_1_BodyDiffV2("", Float) = 0
		[HideInInspector] _UDIMDiscardRow3_2_BodyDiffV2("", Float) = 0
		[HideInInspector] _UDIMDiscardRow3_3_BodyDiffV2("", Float) = 0
		[ThryMultiFloats(true, _UDIMDiscardRow2_1_BodyDiffV2, _UDIMDiscardRow2_2_BodyDiffV2, _UDIMDiscardRow2_3_BodyDiffV2)] _UDIMDiscardRow2_0_BodyDiffV2("v = 2", Float) = 0
		[HideInInspector] _UDIMDiscardRow2_1_BodyDiffV2("", Float) = 0
		[HideInInspector] _UDIMDiscardRow2_2_BodyDiffV2("", Float) = 0
		[HideInInspector] _UDIMDiscardRow2_3_BodyDiffV2("", Float) = 0
		[ThryMultiFloats(true, _UDIMDiscardRow1_1_BodyDiffV2, _UDIMDiscardRow1_2_BodyDiffV2, _UDIMDiscardRow1_3_BodyDiffV2)] _UDIMDiscardRow1_0_BodyDiffV2("v = 1", Float) = 0
		[HideInInspector] _UDIMDiscardRow1_1_BodyDiffV2("", Float) = 0
		[HideInInspector] _UDIMDiscardRow1_2_BodyDiffV2("", Float) = 0
		[HideInInspector] _UDIMDiscardRow1_3_BodyDiffV2("", Float) = 0
		[ThryMultiFloats(true, _UDIMDiscardRow0_1_BodyDiffV2, _UDIMDiscardRow0_2_BodyDiffV2, _UDIMDiscardRow0_3_BodyDiffV2)] _UDIMDiscardRow0_0_BodyDiffV2("v = 0", Float) = 0
		[HideInInspector] _UDIMDiscardRow0_1_BodyDiffV2("", Float) = 0
		[HideInInspector] _UDIMDiscardRow0_2_BodyDiffV2("", Float) = 0
		[HideInInspector] _UDIMDiscardRow0_3_BodyDiffV2("", Float) = 0
		...
		_EmissionStrength1_BodyDiffV2 ("Emission Strength", Range(0, 20)) = 0
		...
		_EmissionStrength2_BodyDiffV2 ("Emission Strength", Range(0, 20)) = 0
		...
		_EmissionStrength3_BodyDiffV2 ("Emission Strength", Range(0, 20)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _UDIMDiscardRow3_0_BodyDiffV2;
			float _UDIMDiscardRow3_1_BodyDiffV2;
			float _UDIMDiscardRow3_2_BodyDiffV2;
			float _UDIMDiscardRow3_3_BodyDiffV2;
			float _UDIMDiscardRow2_0_BodyDiffV2;
			float _UDIMDiscardRow2_1_BodyDiffV2;
			float _UDIMDiscardRow2_2_BodyDiffV2;
			float _UDIMDiscardRow2_3_BodyDiffV2;
			float _UDIMDiscardRow1_0_BodyDiffV2;
			float _UDIMDiscardRow1_1_BodyDiffV2;
			float _UDIMDiscardRow1_2_BodyDiffV2;
			float _UDIMDiscardRow1_3_BodyDiffV2;
			float _UDIMDiscardRow0_0_BodyDiffV2;
			float _UDIMDiscardRow0_1_BodyDiffV2;
			float _UDIMDiscardRow0_2_BodyDiffV2;
			float _UDIMDiscardRow0_3_BodyDiffV2;
			...
			float _EmissionStrength1_BodyDiffV2;
			...
			float _EmissionStrength2_BodyDiffV2;
			...
			float _EmissionStrength3_BodyDiffV2;
			...
			VertexOut vert(appdata v)
			{
				...
				if(0.0 == 0) // Discard Vertices instead of just pixels
				{
					...
					UDIMDiscardRows[0] = float4(_UDIMDiscardRow0_0_BodyDiffV2, _UDIMDiscardRow0_1_BodyDiffV2, _UDIMDiscardRow0_2_BodyDiffV2, _UDIMDiscardRow0_3_BodyDiffV2);
					UDIMDiscardRows[1] = float4(_UDIMDiscardRow1_0_BodyDiffV2, _UDIMDiscardRow1_1_BodyDiffV2, _UDIMDiscardRow1_2_BodyDiffV2, _UDIMDiscardRow1_3_BodyDiffV2);
					UDIMDiscardRows[2] = float4(_UDIMDiscardRow2_0_BodyDiffV2, _UDIMDiscardRow2_1_BodyDiffV2, _UDIMDiscardRow2_2_BodyDiffV2, _UDIMDiscardRow2_3_BodyDiffV2);
					UDIMDiscardRows[3] = float4(_UDIMDiscardRow3_0_BodyDiffV2, _UDIMDiscardRow3_1_BodyDiffV2, _UDIMDiscardRow3_2_BodyDiffV2, _UDIMDiscardRow3_3_BodyDiffV2);
			...
			float3 applyEmission__1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float emissionStrength0__1 = _EmissionStrength1_BodyDiffV2;
				...
				applyALCenterOutEmission__1(poiMods, poiLight.nDotV, emissionStrength0__1, 0.0, 0.0, float4(0,3,0,0), 1.0, 1.0);
			...
			float3 applyEmission__2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float emissionStrength0__2 = _EmissionStrength2_BodyDiffV2;
				float3 emissionColor0__2 = 0;
				applyALEmmissionStrength__2(poiMods, emissionStrength0__2, float4(0,1,0,0), 0.0, float4(0,0,0,0), 1.0, 1.0);
				applyALCenterOutEmission__2(poiMods, poiLight.nDotV, emissionStrength0__2, 0.161, 0.0, float4(0,3,0,0), 1.0, 1.0);
			...
			float3 applyEmission__3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float emissionStrength0__3 = _EmissionStrength3_BodyDiffV2;
				float3 emissionColor0__3 = 0;
				applyALEmmissionStrength__3(poiMods, emissionStrength0__3, float4(0,1,0,0), 2.0, float4(0,0,0,0), 4.0, 1.0);
				applyALCenterOutEmission__3(poiMods, poiLight.nDotV, emissionStrength0__3, 0.103, 2.0, float4(0,3,0,0), 1.0, 1.0);
			...
			void applyPathing(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				float4 PathColor[4] = {
					float4(0.180692,0.2011221,0.9080001,1), float4(1,1,1,1), float4(1,1,1,1), float4(1,1,1,1)
				};
				...
				for (int i = 0; i < 4; i++)
				{
					...
					float timeOffset = 0;
					#endif
					float currentTime = frac((float4(-999,-999,-999,-999)[i] == -999.0f ? _Time.y * float4(0.39,1,1,0.1)[i] : float4(-999,-999,-999,-999)[i]) + float4(0,0,0,0)[i] + timeOffset);
					...
					#ifdef POI_AUDIOLINK
					half pathWidth = float4(3.75,0.03,0.03,0.03)[i] * 0.5 + (0.0 ? alWidthOffsets[i] : 0);
					#else
					half pathWidth = float4(3.75,0.03,0.03,0.03)[i] * 0.5;
					#endif
					half rcpPathWidth = rcp(pathWidth + 1e-6);
					half softness = max(float4(1.24,1,1,1)[i], 0);
					half fillAlpha;
					if (softness > 1e-5)
					{
					...
					half dashAlpha = 0;
					float totalDashLength = float4(3.75,0.03,0.03,0.03)[i] + float4(0.25,0.1,0.1,0.1)[i];
					if (totalDashLength > 1e-6)
					{
						float relativeDashLength = float4(3.75,0.03,0.03,0.03)[i] / totalDashLength;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[0.0].xy, float4(1,1,0,0)), float4(0,0,0,0), 0.0), 1.25);
				#else
