Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/ebc68e2c2ba76f149a582c59051c5e08"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections = surfaceReduction * reflCol * FresnelLerp(specCol, specCol + lerp(specCol, 1, 0.1) * 0.1, pbrNDotV) * SFVisibility(brdfRoughness, poiLight.directColor, pbrNDotV, 0.0);
