Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/da82aac84d416f34894d6f1bfe494b95"
{
	Properties
	{
		...
		[ThryMultiFloats(true, _UDIMDiscardRow3_1_Regulus22E0Body, _UDIMDiscardRow3_2_Regulus22E0Body, _UDIMDiscardRow3_3_Regulus22E0Body)] _UDIMDiscardRow3_0_Regulus22E0Body("v = 3", Float) = 0
		[HideInInspector] _UDIMDiscardRow3_1_Regulus22E0Body("", Float) = 0
		[HideInInspector] _UDIMDiscardRow3_2_Regulus22E0Body("", Float) = 0
		[HideInInspector] _UDIMDiscardRow3_3_Regulus22E0Body("", Float) = 0
		[ThryMultiFloats(true, _UDIMDiscardRow2_1_Regulus22E0Body, _UDIMDiscardRow2_2_Regulus22E0Body, _UDIMDiscardRow2_3_Regulus22E0Body)] _UDIMDiscardRow2_0_Regulus22E0Body("v = 2", Float) = 0
		[HideInInspector] _UDIMDiscardRow2_1_Regulus22E0Body("", Float) = 0
		[HideInInspector] _UDIMDiscardRow2_2_Regulus22E0Body("", Float) = 0
		[HideInInspector] _UDIMDiscardRow2_3_Regulus22E0Body("", Float) = 0
		[ThryMultiFloats(true, _UDIMDiscardRow1_1_Regulus22E0Body, _UDIMDiscardRow1_2_Regulus22E0Body, _UDIMDiscardRow1_3_Regulus22E0Body)] _UDIMDiscardRow1_0_Regulus22E0Body("v = 1", Float) = 0
		[HideInInspector] _UDIMDiscardRow1_1_Regulus22E0Body("", Float) = 0
		[HideInInspector] _UDIMDiscardRow1_2_Regulus22E0Body("", Float) = 0
		[HideInInspector] _UDIMDiscardRow1_3_Regulus22E0Body("", Float) = 0
		[ThryMultiFloats(true, _UDIMDiscardRow0_1_Regulus22E0Body, _UDIMDiscardRow0_2_Regulus22E0Body, _UDIMDiscardRow0_3_Regulus22E0Body)] _UDIMDiscardRow0_0_Regulus22E0Body("v = 0", Float) = 0
		[HideInInspector] _UDIMDiscardRow0_1_Regulus22E0Body("", Float) = 0
		[HideInInspector] _UDIMDiscardRow0_2_Regulus22E0Body("", Float) = 0
		[HideInInspector] _UDIMDiscardRow0_3_Regulus22E0Body("", Float) = 0
		...
		_EmissionStrength1_Regulus22E0Body ("Emission Strength", Range(0, 20)) = 0
		...
		_EmissionStrength2_Regulus22E0Body ("Emission Strength", Range(0, 20)) = 0
		...
		_EmissionStrength3_Regulus22E0Body ("Emission Strength", Range(0, 20)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _UDIMDiscardRow3_0_Regulus22E0Body;
			float _UDIMDiscardRow3_1_Regulus22E0Body;
			float _UDIMDiscardRow3_2_Regulus22E0Body;
			float _UDIMDiscardRow3_3_Regulus22E0Body;
			float _UDIMDiscardRow2_0_Regulus22E0Body;
			float _UDIMDiscardRow2_1_Regulus22E0Body;
			float _UDIMDiscardRow2_2_Regulus22E0Body;
			float _UDIMDiscardRow2_3_Regulus22E0Body;
			float _UDIMDiscardRow1_0_Regulus22E0Body;
			float _UDIMDiscardRow1_1_Regulus22E0Body;
			float _UDIMDiscardRow1_2_Regulus22E0Body;
			float _UDIMDiscardRow1_3_Regulus22E0Body;
			float _UDIMDiscardRow0_0_Regulus22E0Body;
			float _UDIMDiscardRow0_1_Regulus22E0Body;
			float _UDIMDiscardRow0_2_Regulus22E0Body;
			float _UDIMDiscardRow0_3_Regulus22E0Body;
			...
			float _EmissionStrength1_Regulus22E0Body;
			...
			float _EmissionStrength2_Regulus22E0Body;
			...
			float _EmissionStrength3_Regulus22E0Body;
			...
			VertexOut vert(appdata v)
			{
				...
				if(0.0 == 0) // Discard Vertices instead of just pixels
				{
					...
					UDIMDiscardRows[0] = float4(_UDIMDiscardRow0_0_Regulus22E0Body, _UDIMDiscardRow0_1_Regulus22E0Body, _UDIMDiscardRow0_2_Regulus22E0Body, _UDIMDiscardRow0_3_Regulus22E0Body);
					UDIMDiscardRows[1] = float4(_UDIMDiscardRow1_0_Regulus22E0Body, _UDIMDiscardRow1_1_Regulus22E0Body, _UDIMDiscardRow1_2_Regulus22E0Body, _UDIMDiscardRow1_3_Regulus22E0Body);
					UDIMDiscardRows[2] = float4(_UDIMDiscardRow2_0_Regulus22E0Body, _UDIMDiscardRow2_1_Regulus22E0Body, _UDIMDiscardRow2_2_Regulus22E0Body, _UDIMDiscardRow2_3_Regulus22E0Body);
					UDIMDiscardRows[3] = float4(_UDIMDiscardRow3_0_Regulus22E0Body, _UDIMDiscardRow3_1_Regulus22E0Body, _UDIMDiscardRow3_2_Regulus22E0Body, _UDIMDiscardRow3_3_Regulus22E0Body);
			...
			float3 applyEmission__1(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float emissionStrength0__1 = _EmissionStrength1_Regulus22E0Body;
			...
			float3 applyEmission__2(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float emissionStrength0__2 = _EmissionStrength2_Regulus22E0Body;
			...
			float3 applyEmission__3(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float emissionStrength0__3 = _EmissionStrength3_Regulus22E0Body;
			...
			void applyPathing(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				#endif
				float4 PathColor[4] = {
					float4(0.8912172,0.07987322,0.1690786,1), float4(1,1,1,1), float4(1,1,1,1), float4(1,1,1,1)
				};
				...
				for (int i = 0; i < 4; i++)
				{
					...
					float timeOffset = 0;
					#endif
					float currentTime = frac((float4(-999,-999,-999,-999)[i] == -999.0f ? _Time.y * float4(0.79,1,1,0.1)[i] : float4(-999,-999,-999,-999)[i]) + float4(0,0,0,0)[i] + timeOffset);
					...
					#ifdef POI_AUDIOLINK
					half pathWidth = float4(0.24,0.03,0.03,0.03)[i] * 0.5 + (0.0 ? alWidthOffsets[i] : 0);
					#else
					half pathWidth = float4(0.24,0.03,0.03,0.03)[i] * 0.5;
					#endif
					...
					half dashAlpha = 0;
					float totalDashLength = float4(0.24,0.03,0.03,0.03)[i] + float4(0.1,0.1,0.1,0.1)[i];
					if (totalDashLength > 1e-6)
					{
						float relativeDashLength = float4(0.24,0.03,0.03,0.03)[i] / totalDashLength;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[0.0].xy, float4(1,1,0,0)), float4(0,0,0,0), 0.0), 0.25);
				#else
